# Generated by Django 2.0 on 2018-02-10 12:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Course',
            fields=[
                ('par', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('veces_incorrecta', models.IntegerField(auto_created=True, default=0)),
                ('veces_correcta', models.IntegerField(auto_created=True, default=0)),
                ('text', models.CharField(max_length=255, verbose_name='Contenido')),
                ...
                ('Dificultad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FundamentosPlay.Dificultad')),
                ('estado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='FundamentosPlay.Estado')),
            ],
            options={
                'ordering': ['-fecha'],
            },
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='FundamentosPlay.Question'),
        ),
        migrations.AddField(
            model_name='student',
            name='teacher',
